...
def get_web_root(wb, datadir_path, axed_getinfo_var, stop_event=variable.Event(), static_dir=None):
    node = wb.node
    ...
    def get_local_stats():
        ...
        return dict(
            ...
            warnings=p2pool_data.get_warnings(node.tracker, node.best_share_var.value, node.net, axed_getinfo_var.value, node.axed_work.value),
