...
SPREAD = 10 # blocks
IDENTIFIER = 'e238d5b0c6965420'.decode('hex')
PREFIX = '1420c1a53ef76593'.decode('hex')
COINBASEEXT = '3a1035186f5f9c2d4d16532f'.decode('hex')
P2P_PORT = 8999
MIN_TARGET = 0
MAX_TARGET = 2**256//2**20 - 1
PERSIST = True
WORKER_PORT = 7923
BOOTSTRAP_ADDRS = '45.76.57.1 178.62.97.225 85.175.96.251'.split(' ')
