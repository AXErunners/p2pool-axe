...
from p2pool.axe import getwork, data as axe_data
    ...
    def test_all(self):
        ...
        case2s = [
            getwork.BlockAttempt(
                ...
                1305759879,
                axe_data.FloatingInteger.from_target_upper_bound(0x44b9f20000000000000000000000000000000000000000000000),
