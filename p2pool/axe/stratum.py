...
from p2pool.axe import data as axe_data, getwork
...
class StratumRPCMiningProvider(object):
    ...
    def _send_work(self):
        ...
        self.other.svc_mining.rpc_set_difficulty(axe_data.target_to_difficulty(x['share_target'])).addErrback(lambda err: None)
    ...
    def rpc_submit(self, worker_name, job_id, extranonce2, ntime, nonce):
        ...
        header = dict(
            ...
            merkle_root=axe_data.check_merkle_link(axe_data.hash256(new_packed_gentx), x['merkle_link']),
