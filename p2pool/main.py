...
def main(args, net, datadir_path, merged_urls, worker_endpoint):
    try:
        ...
        @defer.inlineCallbacks
        def poll_warnings():
            axed_getinfo_var.set((yield deferral.retry('Error while calling getinfo:')(axed.rpc_getinfo)()))
        yield poll_warnings()
        ...
        web_root = web.get_web_root(wb, datadir_path, axed_getinfo_var, static_dir=args.web_static)
            ...
            while True:
                ...
                try:
                    ...
                    if height > 2:
                        ...
                        for warning in p2pool_data.get_warnings(node.tracker, node.best_share_var.value, net, axed_getinfo_var.value, node.axed_work.value):
                            print >>sys.stderr, '#'*40
